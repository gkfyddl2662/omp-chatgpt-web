...
export function compileBrowserPrompt(context: Context, turnToken: string): string {
  ...
  return [
    ...
    "- Do NOT finish only by writing prose in the ChatGPT UI.",
    ...
    "- After omp_turn_complete returns success, render exactly that same answer as normal ChatGPT assistant prose. Do not add a preface, do not summarize it again, and do not call any more tools.",
